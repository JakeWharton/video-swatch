...
class SliceSummarizerTest {
	...
	@Test fun gapsAreKept() {
		val summarizer = SliceSummarizer(framePixels = 10)
		summarizer.addToSlice(0, FrameSummary(red = 40L, green = 160L, blue = 640L))
		summarizer.addToSlice(2, FrameSummary(red = 40L, green = 160L, blue = 640L))
